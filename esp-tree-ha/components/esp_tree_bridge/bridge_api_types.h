...
static constexpr const char *kProtocolName = "esp-tree-ws";
static constexpr const char *kProtocolVersionLabel = "v1";
static constexpr const char *kWebSocketPath = "/esp-tree/v1/ws";
...
static constexpr const char *NODE_CONFIG = "node.config";
static constexpr const char *NODE_CONFIG_RESULT = "node.config.result";
static constexpr const char *OTA_START = "ota.start";
static constexpr const char *OTA_ACCEPTED = "ota.accepted";
static constexpr const char *OTA_CHUNK_REQUEST = "ota.chunk_request";
...
struct NodeSubscriptions {
  std::set<std::string> state_subscribed_nodes;
};
