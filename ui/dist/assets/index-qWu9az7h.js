 ...
 */function Hc(i,e){return(t,s,n)=>{const r=o=>{var a;return((a=o.renderRoot)==null?void 0:a.querySelector(i))??null};return dp(t,s,{get(){return r(this)}})}}const fp=(()=>{const i=document.querySelector('meta[name="x-ingress-path"]');return i&&i.getAttribute("content")?i.getAttribute("content").replace(/\/+$/,""):""})(),up=15e3,pp=3e4;let gn=null,Jr=null;function mi(i){const e=fp||"";return i.startsWith("/")?e+i:e+"/"+i}function gp(i,e){if(!i)return null;if(e!=null&&e.includes("application/json"))return JSON.parse(i);try{return JSON.parse(i)}catch{return i}}async function E(i,e){const t=new AbortController,s=setTimeout(()=>t.abort("timeout"),up);try{const n=await fetch(mi(i),{...e,signal:t.signal,headers:(e==null?void 0:e.body)instanceof FormData?e.headers:{"Content-Type":"application/json",...(e==null?void 0:e.headers)||{}}});clearTimeout(s);const r=await n.text(),o=gp(r,n.headers.get("content-type"));if(!n.ok){let a=`${n.status} ${n.statusText}`;if(o&&typeof o=="object"){const l=o,h=l.detail,c=l.error;typeof h=="string"&&h?a=h:typeof c=="string"&&c&&(a=c)}else typeof o=="string"&&o&&(a=o);throw new Error(a)}return o}catch(n){if(clearTimeout(s),n instanceof DOMException&&n.name==="AbortError"){const r=t.signal.reason;throw new Error(r==="timeout"?"timeout":"cancelled")}throw n}}const S={config:()=>E("/api/config"),updateConfig:i=>E("/api/config",{method:"PUT",body:JSON.stringify(i)}),discoverBridges:()=>E("/api/bridge/discover"),triggerScan:()=>E("/api/bridge/scan",{method:"POST"}),getScanLog:()=>E("/api/bridge/scan-log"),getBridges:()=>E("/api/bridges"),addBridge:(i,e,t,s,n)=>E("/api/bridges",{method:"POST",body:JSON.stringify({host:i,port:e,name:t,api_key:s,hostname:n})}),updateBridge:(i,e,t,s,n)=>E(`/api/bridges/${i}`,{method:"PUT",body:JSON.stringify({name:e,host:t,port:s,api_key:n})}),deleteBridge:i=>E(`/api/bridges/${i}`,{method:"DELETE"}),activateBridge:i=>E(`/api/bridges/${i}/activate`,{method:"PUT"}),deactivateBridge:i=>E(`/api/bridges/${i}/deactivate`,{method:"PUT"}),bridgeReconnect:i=>E(`/api/bridges/${i}/reconnect`,{method:"POST"}),selectBridge:(i,e,t,s,n,r,o)=>E("/api/bridge/select",{method:"POST",body:JSON.stringify({host:i,port:e,name:t,version:s,api_key:n,network_id:r,hostname:o})}),topology:(i=!1)=>{const e=Date.now();return!i&&gn&&e-gn.ts<pp?Promise.resolve(gn.data):E("/api/bridge/topology.json").then(t=>(gn={data:t,ts:e},t))},hideDevice:i=>E(`/api/topology/hide/${encodeURIComponent(i)}`,{method:"DELETE"}),unhideDevice:i=>E(`/api/topology/unhide/${encodeURIComponent(i)}`,{method:"POST"}),devices:()=>E("/api/devices"),device:i=>E(`/api/devices/${encodeURIComponent(i)}`),currentOta:()=>E("/api/ota/current"),currentOtaForDevice:i=>E(`/api/ota/current?mac=${encodeURIComponent(i)}`),uploadFirmware:(i,e)=>{const t=new FormData;return t.set("mac",i),t.set("file",e),E("/api/ota/upload",{method:"POST",body:t})},startOta:i=>E(`/api/ota/start/${i}`,{method:"POST"}),abortOta:()=>E("/api/ota/abort",{method:"POST"}),cancelPending:i=>E(`/api/ota/pending/${i}`,{method:"DELETE"}),getQueue:()=>E("/api/ota/queue"),getQueuePaused:()=>E("/api/ota/queue/paused"),pauseQueue:()=>E("/api/ota/queue/pause",{method:"POST"}),resumeQueue:()=>E("/api/ota/queue/resume",{method:"POST"}),abortQueuedJob:i=>E(`/api/ota/queue/${i}/abort`,{method:"POST"}),reorderJobUp:i=>E(`/api/ota/queue/${i}/up`,{method:"POST"}),reorderJobDown:i=>E(`/api/ota/queue/${i}/down`,{method:"POST"}),history:i=>E(`/api/ota/history/${encodeURIComponent(i)}`),jobLog:i=>E(`/api/ota/jobs/${i}/log`),retained:()=>E("/api/firmware/retained"),reflash:i=>E(`/api/ota/reflash/${i}`,{method:"POST"}),deleteRetained:i=>E(`/api/firmware/retained/${i}`,{method:"DELETE"}),getConfig:i=>E(`/api/devices/${encodeURIComponent(i)}/config`),saveConfig:(i,e,t)=>E(`/api/devices/${encodeURIComponent(i)}/config`,{method:"PUT",body:JSON.stringify({content:e,scaffold:t})}),deleteConfig:i=>E(`/api/devices/${encodeURIComponent(i)}/config`,{method:"DELETE"}),importConfig:(i,e)=>{if(typeof e=="string")return E(`/api/devices/${encodeURIComponent(i)}/config/import`,{method:"POST",body:JSON.stringify({content:e})});const t=new FormData;return t.set("file",e),E(`/api/devices/${encodeURIComponent(i)}/config/import`,{method:"POST",body:t})},getConfigStatus:i=>E(`/api/devices/${encodeURIComponent(i)}/config/status`),compileDevice:i=>E(`/api/devices/${encodeURIComponent(i)}/compile`,{method:"POST"}),getCompileStatus:i=>E(`/api/devices/${encodeURIComponent(i)}/compile/status`),cancelCompile:i=>E(`/api/devices/${encodeURIComponent(i)}/compile/cancel`,{method:"POST"}),startCompileFlash:i=>E(`/api/devices/${encodeURIComponent(i)}/compile/start-flash`,{method:"POST"}),getCompileHistory:i=>E(`/api/devices/${encodeURIComponent(i)}/compile/history`),rebootDevice:i=>E(`/api/devices/${encodeURIComponent(i)}/reboot`,{method:"POST"}),setHeartbeatInterval:(i,e)=>E(`/api/devices/${encodeURIComponent(i)}/heartbeat`,{method:"POST",body:JSON.stringify({interval_seconds:e})}),forceRediscover:i=>E(`/api/devices/${encodeURIComponent(i)}/rediscover`,{method:"POST"}),setParentMac:(i,e,t=!0)=>E(`/api/devices/${encodeURIComponent(i)}/parent`,{method:"POST",body:JSON.stringify({parent_mac:e,clear:t})}),setRelay:(i,e)=>E(`/api/devices/${encodeURIComponent(i)}/relay`,{method:"POST",body:JSON.stringify({enable:e})}),getCompileQueue:()=>E("/api/compile/queue"),abortCompileJob:i=>E(`/api/compile/queue/${i}/abort`,{method:"POST"}),getSecrets:()=>E("/api/secrets"),saveSecrets:i=>E("/api/secrets",{method:"PUT",body:JSON.stringify({content:i})}),getContainerStatus:()=>E("/api/compile/container/status"),cleanArtifacts:()=>E("/api/compile/artifacts",{method:"DELETE"}),getSerialPorts:()=>E("/api/serial/ports"),startSerialFlash:(i,e)=>E(`/api/devices/${encodeURIComponent(i)}/flash/serial`,{method:"POST",body:JSON.stringify({port:e})}),getSerialFlashStatus:i=>E(`/api/devices/${encodeURIComponent(i)}/flash/serial/status`),cancelSerialFlash:i=>E(`/api/devices/${encodeURIComponent(i)}/flash/serial/cancel`,{method:"POST"}),restartRequired:()=>E("/api/restart-required"),requestRestart:()=>E("/api/restart",{method:"POST"}),setupStatus:()=>E("/api/setup-status"),integrationSetup:()=>E("/api/integration/setup",{method:"POST"}),streamCompileLogs(i,e,t){const s=mi(`/api/devices/${encodeURIComponent(i)}/compile/logs`),n=new EventSource(s);return n.onmessage=r=>{e(r.data)},n.addEventListener("status",r=>{e(`[status: ${r.data}]`)}),n.addEventListener("exit",r=>{e(`[build exited with code ${r.data}]`)}),n.addEventListener("queue_position",r=>{e(`[queue position: ${r.data}]`)}),n.onerror=t,n},streamSerialFlashLogs(i,e,t,s){const n=mi(`/api/devices/${encodeURIComponent(i)}/flash/serial/logs`),r=new EventSource(n);return r.onmessage=o=>{e(o.data)},r.addEventListener("status",o=>{t(o.data)}),r.onerror=s,r},downloadFactoryBinary(i){return mi(`/api/devices/${encodeURIComponent(i)}/firmware/download`)},activityLog(i,e,t){const s=mi("/api/integration/activity"),n=new EventSource(s);return n.addEventListener("line",r=>{i(r.data)}),n.addEventListener("end",()=>{e()}),n.addEventListener("error",r=>{t(r)}),n.onerror=t,n}};function mp(i){let e=null,t=!1,s=1e3;const n=()=>{if(t)return;const r=mi("/ws/topology");e=new WebSocket(r),e.onopen=()=>{s=1e3},e.onmessage=o=>{try{const a=JSON.parse(o.data);a.type==="bridge.connection"&&typeof a.payload=="object"&&a.payload!==null&&i(a.payload.connected)}catch{}},e.onclose=()=>{t||(setTimeout(n,s),s=Math.min(s*2,1e4))},e.onerror=()=>{e==null||e.close()}};return n(),{close(){t=!0,e==null||e.close()}}}function bp(i){let e=null,t=!1,s=1e3;const n=()=>{if(t)return;const r=mi("/ws/topology");e=new WebSocket(r),e.onopen=()=>{s=1e3},e.onmessage=o=>{try{const a=JSON.parse(o.data);a&&a.type==="server_id"&&typeof a.value=="string"&&(Jr!==null&&Jr!==a.value&&location.reload(),Jr=a.value),i(a)}catch{}},e.onclose=()=>{t||(setTimeout(n,s),s=Math.min(s*2,1e4))},e.onerror=()=>{e==null||e.close()}};return n(),{close(){t=!0,e==null||e.close()}}}function he(i){const e=i.replace(/[^0-9A-Fa-f]/g,"");return e.length!==12?i.trim().toUpperCase():e.match(/.{2}/g).join(":").toUpperCase()}function ki(i){const e=i||0;return e<1024?`${e} B`:e<1024*1024?`${(e/1024).toFixed(1)} KB`:`${(e/1024/1024).toFixed(2)} MB`}function is(i){return i?new Date(i*1e3).toLocaleString():"-"}function Si(i){if(i==null||i<=0)return"";const e=Number(i);if(e<60)return`${e}s`;if(e<3600)return`${Math.floor(e/60)}m ${e%60}s`;const t=Math.floor(e/3600),s=Math.floor(e%3600/60);return`${t}h ${s}m`}var yp=Object.defineProperty,vp=Object.getOwnPropertyDescriptor,zt=(i,e,t,s)=>{for(var n=s>1?void 0:s?vp(e,t):e,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=(s?o(e,t,n):o(n))||n);return s&&n&&yp(e,t,n),n};function xp(i){if(i.offline_started_at&&i.offline_started_at>0)return Math.floor(Date.now()/1e3-i.offline_started_at);if(i.last_seen_bridge_uptime_s&&i.bridge_uptime_s&&!i.online)return Math.max(0,i.bridge_uptime_s-i.last_seen_bridge_uptime_s)}let rt=class extends re{constructor(){super(...arguments),this.childNodesData=[],this.childMap=new Map,this.jobForMac=()=>null,this.configForMac=()=>null,this.onHideDevice=()=>{},this.isRoot=!1,this.isLast=!1}selectNode(){this.dispatchEvent(new CustomEvent("node-selected",{detail:this.node.mac,bubbles:!0,composed:!0}))}navigateTo(i){window.location.hash=i}rssiBars(i){return i==null?"-":i>=-50?"▂▄▆█":i>=-65?"▂▄▆":i>=-80?"▂▄":i>=-90?"▂":"▁"}childKey(i){return he(i.mac||"")}render(){const i=this.jobForMac(this.node.mac),e=!!i&&["starting","transferring","verifying","transfer_success_waiting_rejoin"].includes(i.status),t=!!i&&i.status==="queued",s=(i==null?void 0:i.percent)??0,n=this.childNodesData.length>0,r=(this.node.hops??0)>0,o=this.configForMac(this.node.mac),a=(o==null?void 0:o.config_state)??"no_config";return g`
      <div class="tree-row">
        ...
        <div class="tree-node ${this.node.online?"online":"offline"}" @click=${this.selectNode}>
          ...
          <span class="metrics">
            <span class="${this.node.online?"":"offline-metric"}">${this.node.online?Si(this.node.uptime_s):Si(xp(this.node))}</span>
            ${!this.isRoot&&this.node.online&&this.node.last_seen_ago?g`<span class="last-seen">${Si(this.node.last_seen_ago)} ago</span>`:y}
            ${this.isRoot?y:g`
  ...
  `;at([q({type:String})],Ue.prototype,"mac",2);at([q({type:Object})],Ue.prototype,"node",2);at([q({type:Object})],Ue.prototype,"currentJob",2);at([w()],Ue.prototype,"pendingJob",2);at([w()],Ue.prototype,"preflight",2);at([w()],Ue.prototype,"acceptedWarnings",2);at([w()],Ue.prototype,"busy",2);at([w()],Ue.prototype,"error",2);at([w()],Ue.prototype,"completedJob",2);at([w()],Ue.prototype,"showAbortModal",2);Ue=at([be("esp-ota-box")],Ue);var Mp=Object.defineProperty,Tp=Object.getOwnPropertyDescriptor,rn=(i,e,t,s)=>{for(var n=s>1?void 0:s?Tp(e,t):e,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=(s?o(e,t,n):o(n))||n);return s&&n&&Mp(e,t,n),n};let Pi=class extends re{constructor(){super(...arguments),this.jobs=[],this.mac="",this.busyJob=null,this.error=""}retained(i){return!!i.firmware_path&&!!i.retained_until&&i.retained_until>Math.floor(Date.now()/1e3)}viewLog(i){const e=`/device/${encodeURIComponent(this.mac||i.mac)}`;window.location.hash=`/job/${i.id}?from=${encodeURIComponent(e)}`}async reflash(i){this.busyJob=i.id,this.error="";try{const e=await S.reflash(i.id);this.dispatchEvent(new CustomEvent("ota-reflash-result",{bubbles:!0,composed:!0,detail:{job:e.job,preflight:e.preflight}})),this.dispatchChanged()}catch(e){this.error=e instanceof Error?e.message:String(e)}finally{this.busyJob=null}}async deleteRetained(i){this.busyJob=i.id,this.error="";try{await S.deleteRetained(i.id),this.dispatchChanged()}catch(e){this.error=e instanceof Error?e.message:String(e)}finally{this.busyJob=null}}dispatchChanged(){this.dispatchEvent(new CustomEvent("ota-changed",{bubbles:!0,composed:!0}))}render(){return g`
      <section>
        <div class="title-row">
          <div>
            <h2>Flash Log</h2>
                ...
                ${this.jobs.map(i=>g`
                    <article>
                      <div>
                        ...
                        <small>${is(i.created_at)} / ${ki(i.firmware_size)}</small>
                      </div>
      ...
      <section class="hero">
        <div class="hero-left">
          ...
          <div class="hero-stats">
            ...
            <div class="hero-box sm"><span class="lbl">Last Seen</span><span class="val">${this.node.last_seen_ago?Si(this.node.last_seen_ago):"-"}</span></div>
...
`)}</pre>
  ...
  `;ne([q({type:String})],te.prototype,"mac",2);ne([w()],te.prototype,"state",2);ne([w()],te.prototype,"device",2);ne([w()],te.prototype,"config",2);ne([w()],te.prototype,"editorContent",2);ne([w()],te.prototype,"saveIndicator",2);ne([w()],te.prototype,"error",2);ne([w()],te.prototype,"compilePhase",2);ne([w()],te.prototype,"compileJobId",2);ne([w()],te.prototype,"compileQueuePosition",2);ne([w()],te.prototype,"preflight",2);ne([w()],te.prototype,"chipUnknown",2);ne([w()],te.prototype,"acceptedWarnings",2);ne([w()],te.prototype,"yamlWarnings",2);ne([w()],te.prototype,"showCompileLog",2);ne([w()],te.prototype,"serialPanelOpen",2);ne([w()],te.prototype,"serialPorts",2);ne([w()],te.prototype,"selectedSerialPort",2);ne([w()],te.prototype,"serialPortsLoading",2);ne([w()],te.prototype,"serialStatus",2);ne([w()],te.prototype,"serialError",2);ne([w()],te.prototype,"serialLogs",2);ne([Hc("esp-compile-log-viewer")],te.prototype,"compileLogViewer",2);te=ne([be("esp-config-page")],te);var J1=Object.defineProperty,K1=Object.getOwnPropertyDescriptor,un=(i,e,t,s)=>{for(var n=s>1?void 0:s?K1(e,t):e,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=(s?o(e,t,n):o(n))||n);return s&&n&&J1(e,t,n),n};let Ei=class extends re{constructor(){super(...arguments),this.content="",this.saved=!1,this.loading=!0,this.error=""}connectedCallback(){super.connectedCallback(),this.load()}async load(){this.loading=!0;try{const i=await S.getSecrets();this.content=i.content,this.error=""}catch(i){this.error=i instanceof Error?i.message:String(i)}finally{this.loading=!1}}async save(){this.saved=!1;try{await S.saveSecrets(this.content),this.saved=!0,this.error="",setTimeout(()=>{this.saved=!1,this.requestUpdate()},2e3)}catch(i){this.error=i instanceof Error?i.message:String(i)}}onInput(i){this.content=i.target.value}goBack(){window.location.hash="/"}render(){return g`
      <button class="back" @click=${this.goBack}>&#8592; Back to topology</button>
      <h2>Secrets</h2>
  ...
  `;ai([q({type:Number})],Ot.prototype,"jobId",2);ai([q({type:String})],Ot.prototype,"from",2);ai([w()],Ot.prototype,"job",2);ai([w()],Ot.prototype,"logData",2);ai([w()],Ot.prototype,"error",2);ai([w()],Ot.prototype,"loading",2);ai([w()],Ot.prototype,"expandedOutput",2);Ot=ai([be("esp-job-page")],Ot);var iw=Object.defineProperty,sw=Object.getOwnPropertyDescriptor,gs=(i,e,t,s)=>{for(var n=s>1?void 0:s?sw(e,t):e,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=(s?o(e,t,n):o(n))||n);return s&&n&&iw(e,t,n),n};let ni=class extends re{constructor(){super(...arguments),this.logs=[],this.error="",this.loading=!0,this.fullscreen=!1,this.connected=!1,this.eventSource=null,this.handleFullscreenChange=()=>{this.fullscreen=!!document.fullscreenElement}}connectedCallback(){super.connectedCallback(),this.connect()}connect(){this.disconnect(),this.loading=!0,this.error="",this.logs=[],this.eventSource=S.activityLog(i=>{this.logs=[i,...this.logs],this.loading=!1,this.connected=!0,this.requestUpdate()},()=>{this.loading=!1},i=>{this.loading=!1,this.logs.length===0&&(this.error="Could not load activity log")})}disconnect(){this.eventSource&&(this.eventSource.close(),this.eventSource=null,this.connected=!1)}clearLogs(){this.logs=[]}downloadLog(){const i=this.logs.join(`
