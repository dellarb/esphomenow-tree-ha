...
#define ESPNOW_LR_DISCOVER_COLLECTION_WINDOW_MS 40
#define ESPNOW_LR_PREFERRED_RSSI_FLOOR_DBM -85
#define ESPNOW_LR_TOPOLOGY_REFRESH_INTERVAL_MS 120000
#define ESPNOW_LR_RSSI_EMA_ALPHA 10  // actual alpha = 1/10 = 0.1
...
static inline const char* abort_reason_to_string(uint8_t reason) {
  switch (reason) {
    case ESPNOW_LR_FILE_ABORT_USER:        return "user_abort";
    case ESPNOW_LR_FILE_ABORT_TIMEOUT:     return "timeout";
    case ESPNOW_LR_FILE_ABORT_SESSION_LOST: return "session_lost";
    case ESPNOW_LR_FILE_ABORT_SEND_FAILURE: return "send_failure";
    case ESPNOW_LR_FILE_ABORT_FLASH_ERROR:  return "flash_error";
